...
all_results <- data.frame(
  ...
  Type = c(rep("Standard", 4), rep("Custom", 2)),
  stringsAsFactors = FALSE
)
...
all_results <- all_results %>%
  ...
  select(Rank, Layout, Type, Effort, Relative, `vs QWERTZ`)

all_results$Effort <- round(all_results$Effort, 2)

knitr::kable(
  all_results,
  caption = "Final layout rankings - Lower effort is better",
  col.names = c("Rank", "Layout", "Type", "Effort", "Relative (%)", "vs QWERTZ"),
  align = c("c", "l", "l", "r", "r", "r")
)
```
