...
> ⚠️ **This is a work in progress!** The layout, the name, and even the methodology 
> are all open for discussion. I'm sharing this early because I'd love to hear from
> the community—especially those who type in multiple languages daily. Your feedback
...
reap most of the rewards—just 5 strategic key swaps can achieve **70% of the effort 
reduction** of a fully optimized layout, while the learning curve remains manageable.

QWERTZ-LUX follows this principle. It's essentially a fork of BÉPO's structure, but
...
Finger strength matters too—index fingers are stronger than pinkies.
...
or "BÉPO." Here are some alternatives I'm considering:
