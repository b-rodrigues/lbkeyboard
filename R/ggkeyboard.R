...
text_colour_adjust <- function(fill, text_colour, adjust_text_colour) {
  ...
  # Convert prismatic colors to character to avoid vctrs type conflicts
  result <- dplyr::case_when(
    fill_dark & adjust_text_colour & text_colour_dark ~ as.character(prismatic::clr_lighten(text_colour)),
    !fill_dark & adjust_text_colour & !text_colour_dark ~ as.character(prismatic::clr_darken(text_colour)),
    TRUE ~ as.character(text_colour)
  )
  result
}
